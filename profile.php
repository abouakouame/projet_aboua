    ...
    if ($getUinfo) {
     ...
     ?>
          ...
          <form class="" action="" method="POST">
              ...
              ">
                <div class="form-group">
                  <label for="sel1">selection du rôle</label>
                ...
                if($getUinfo->roleid == '1'){?>
                  ...
                  <option value="3">utilisateur en ligne</option>
                ...
                <?php }elseif($getUinfo->roleid == '3'){?>
                  <option value="1">Admin sup</option>
                  <option value="2">Admin</option>
                  <option value="3" selected='selected'>simple utilistateur</option>
          ...
          <?php } ?>
              ...
              <div class="form-group">
                ...
                <a class="btn btn-primary" href="changepass.php?id=<?php echo $getUinfo->id;?>">change le mots de passe</a>
              </div>
            ...
            <?php } elseif(Session::get("roleid") == '2') {?>
              ...
              <div class="form-group">
                <button type="submit" name="update" class="btn btn-success">mise jour</button>
